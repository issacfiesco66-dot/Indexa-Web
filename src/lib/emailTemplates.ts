  ...
  return `
    <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333333; background-color: #F8F9FA;">
      ...
      <div style="background-color: #002366; padding: 32px; text-align: center;">
        ...
        <p style="color: rgba(255,255,255,0.7); margin: 8px 0 0; font-size: 14px;">Presencia Digital para PYMES</p>
      </div>
      ...
      <div style="padding: 32px; background-color: #FFFFFF;">
        ...
        <p style="font-size: 16px; line-height: 1.7; color: #333333;">
          Hola, notamos que <strong>${businessName}</strong> no tiene una página web optimizada.
          En <strong>INDEXA</strong> creamos una demo exclusiva para ustedes que pueden ver aquí:
        </p>
        ...
        <div style="margin: 20px 0; padding: 20px; background-color: #F8F9FA; border-radius: 12px; border: 1px solid #e5e7eb;">
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              <td style="padding: 8px 12px; font-size: 15px; color: #333;">✅ Recibir contactos directo a WhatsApp desde su página</td>
            </tr>
            <tr>
              <td style="padding: 8px 12px; font-size: 15px; color: #333;">✅ Verse profesional ante sus clientes potenciales</td>
            </tr>
            <tr>
              <td style="padding: 8px 12px; font-size: 15px; color: #333;">✅ Tener todo listo sin que usted haga nada técnico</td>
            </tr>
          </table>
        </div>
