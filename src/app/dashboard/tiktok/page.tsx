    ...
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
          ...
          <Link
            href="/dashboard"
            className="mb-6 inline-flex items-center gap-1.5 text-sm text-gray-500 transition-colors hover:text-indexa-blue"
          >
            <ArrowLeft size={16} />
            Volver al dashboard
          </Link>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-5xl space-y-6 px-4 py-8 sm:px-6">
        ...
        <Link
          href="/dashboard"
          className="inline-flex items-center gap-1.5 text-sm text-gray-500 transition-colors hover:text-indexa-blue"
        >
          <ArrowLeft size={16} />
          Volver al dashboard
        </Link>
