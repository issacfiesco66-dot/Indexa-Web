const solutions = [
  ...
  {
    title: "Panel de Marketing (Meta Ads)",
    description:
      "Gestiona tus campañas de Facebook e Instagram desde tu panel. Pausar, reanudar y ver métricas en tiempo real sin abrir el Ads Manager.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-8 w-8">
  ...
  },
  {
    ...
    description:
      "Ve cuántas personas visitan tu sitio, cuántas te contactan por WhatsApp y mide el impacto real de tu presencia digital. Todo desde tu panel.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-8 w-8">
